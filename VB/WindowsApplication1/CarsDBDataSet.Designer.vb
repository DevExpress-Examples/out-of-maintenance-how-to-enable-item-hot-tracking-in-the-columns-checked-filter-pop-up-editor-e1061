	...
	Partial Public Class CarsDBDataSet
		...
		Partial Public Class CarsDataTable
			...
			Public Function AddCarsRow(ByVal Trademark As String, ByVal Model As String, ByVal HP As Short) As CarsRow
				...
				Dim columnValuesArray() As Object = { Nothing, Trademark, Model, HP}
...
Namespace WindowsApplication1.CarsDBDataSetTableAdapters
	...
	Partial Public Class CarsTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Cars` WHERE ((`ID` = ?) AND ((? = 1 AND `Trademark` IS NULL) OR (`Tr" & "ademark` = ?)) AND ((? = 1 AND `Model` IS NULL) OR (`Model` = ?)) AND ((? = 1 AN" & "D `HP` IS NULL) OR (`HP` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Cars` (`Trademark`, `Model`, `HP`) VALUES (?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Cars` SET `Trademark` = ?, `Model` = ?, `HP` = ? WHERE ((`ID` = ?) AND ((" & "? = 1 AND `Trademark` IS NULL) OR (`Trademark` = ?)) AND ((? = 1 AND `Model` IS " & "NULL) OR (`Model` = ?)) AND ((? = 1 AND `HP` IS NULL) OR (`HP` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ID, Trademark, Model, HP FROM Cars"
		...
		Public Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_HP As Global.System.Nullable(Of Short)) As Integer
		...
		Public Overridable Function Insert(ByVal Trademark As String, ByVal Model As String, ByVal HP As Global.System.Nullable(Of Short)) As Integer
		...
		Public Overridable Function Update(ByVal Trademark As String, ByVal Model As String, ByVal HP As Global.System.Nullable(Of Short), ByVal Original_ID As Integer, ByVal Original_Trademark As String, ByVal Original_Model As String, ByVal Original_HP As Global.System.Nullable(Of Short)) As Integer
			If (Trademark Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(5).Value = (CStr(Original_Trademark))
			End If
			If (Original_Model Is Nothing) Then
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(7).Value = (CStr(Original_Model))
			End If
			If (Original_HP.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(8).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CShort(Fix(Original_HP.Value)))
			Else
